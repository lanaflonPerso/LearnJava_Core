...
/**
 * This class defines a bunch of static methods for efficiently sorting arrays
 * of Strings or other objects. It also defines two interfaces that provide two
 * different ways of comparing objects to be sorted.
 **/
public class Sorter {
	/**
	 * This interface defines the compare() method used to compare two objects. To
	 * sort objects of a given type, you must provide a Comparer object with a
	 * compare() method that orders those objects as desired
	 **/
	public static interface Comparer {
		/**
		 * Compare objects, return a value that indicates their relative order: if (a >
		 * b) return > 0; if (a == b) return 0; if (a < b) return < 0.
		 **/
	...
	public static interface Comparable {
		/**
		 * Compare objects, return a value that indicates their relative order: if (this
		 * > other) return > 0 if (this == other) return 0 if (this < other) return < 0
		 **/
		public int compareTo(Object other);
	}

	/**
	 * This is an internal Comparer object (created with an anonymous class) that
	 * compares two ASCII strings. It is used in the sortAscii methods below.
	 **/
	...
	/**
	 * Sort an array of strings into ascending order, using the correct collation
	...
	/**
	 * Sort a portion of an array of strings, using the collation order of the
	 * default locale. If up is true, sort ascending, otherwise, sort descending. If
	 * ignorecase is true, ignore the capitalization of letters
	 **/
	...
	/**
	 * Sort a portion of an array of strings, using the collation order of the
	 * specified locale. If up is true, sort ascending, otherwise, sort descending.
	 * If ignorecase is true, ignore the capitalization of letters
	 **/
	...
	/**
	 * Sort a portion of an array of Comparable objects. If up is true, sort into
	 * ascending order, otherwise sort into descending order.
	 **/
	...
	/**
	 * Sort a portion of array a of Comparable objects. If up is true, sort into
	 * ascending order, otherwise sort into descending order. Re-arrange the array b
	...
	/**
	 * Sort an array of arbitrary objects into ascending order, using the comparison
	 * defined by the Comparer object c
	 **/
	...
	/**
	 * Sort a portion of an array of objects, using the comparison defined by the
	 * Comparer object c. If up is true, sort into ascending order, otherwise sort
	...
	/**
	 * This is the main sort() routine. It performs a quicksort on the elements of
	 * array a between the element from and the element to. The up argument
	 ...
	 * comparisons between elements of the array. The elements of the array b are
	 * reordered in exactly the same way as the elements of array a are.
	 **/
	public static void sort(Object[] a, Object[] b, int from, int to, boolean up, Comparer c) {
		...
		if (from < j)
			sort(a, b, from, j, up, c); // recursively sort the rest
		if (i < to)
			sort(a, b, i, to, up, c);
	}

	/**
	 * This nested class defines a test program that demonstrates several ways to
	 * use the Sorter class to sort ComplexNumber objects
	 **/
	public static class Test {
		/**
		 * This subclass of ComplexNumber implements the Comparable interface and
		 * defines a compareTo() method for comparing complex numbers. It compares
		 * numbers based on their magnitude. I.e. on their distance from the origin.
		 **/
