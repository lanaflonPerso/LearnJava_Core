...
public class FileLister extends Frame implements ActionListener, ItemListener {
	...
	private Panel buttonsPanel; // Holds the buttons
	...
	public FileLister(String directory, FilenameFilter filter) {
		...
		buttonsPanel = new Panel(); // Set up the button box
		buttonsPanel.setLayout(new FlowLayout(FlowLayout.RIGHT, 15, 5));
		buttonsPanel.setFont(new Font("SansSerif", Font.BOLD, 14));
		...
		buttonsPanel.add(up); // Add buttons to button box
